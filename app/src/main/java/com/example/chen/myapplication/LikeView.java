...
public class LikeView extends View {
    ...
    /**
     * 测量View的宽高
     * @param measureSpec  MeasureSpec 实例
     * @param defaultVal    默认值 当mode 为UNSPECIFIED 和ATMOST时使用默认值
     * @return 测量后的宽高
     */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        setMeasuredDimension(measureMeasureSpec(widthMeasureSpec,defWidth),
                measureMeasureSpec(heightMeasureSpec,defHeight));
    }
    ...
    private void drawNumber(Canvas canvas) {
        ...
        {   //是否正在动画中
            ...
            //绘制旧文本
            canvas.drawText(postNewNumStr,preNumWidth,textBaseLineHeight + textHeight * numAnimateScale,textPaint);
            //绘制新文本
